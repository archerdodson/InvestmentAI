...
export const healthcareNews: NewsItem[] = [
  { id: "1", title: "Pfizer Acquires Seagen in $43B Cancer Drug Deal", source: "Bloomberg", time: "2h ago", type: "ma", amount: "$43B", companies: ["Pfizer", "Seagen"], summary: "Pfizer completed its acquisition of cancer biotech Seagen, marking the largest pharma deal of 2026 and expanding its oncology pipeline significantly." },
  { id: "2", title: "Tempus AI Raises $500M Series G at $8.1B Valuation", source: "TechCrunch", time: "4h ago", type: "funding", amount: "$500M", companies: ["Tempus AI"], summary: "Precision medicine company Tempus AI closed a $500M Series G round led by SoftBank Vision Fund, bringing total funding to $1.8B." },
  { id: "3", title: "Johnson & Johnson Spins Off Consumer Health Division", source: "Reuters", time: "6h ago", type: "deal", amount: "$40B", companies: ["J&J", "Kenvue"], summary: "J&J completed the spin-off of its consumer health business Kenvue, creating a focused pharmaceutical and medtech company." },
  { id: "4", title: "Recursion Pharma Merges with Exscientia in AI Drug Discovery", source: "FierceBiotech", time: "8h ago", type: "ma", amount: "$3.2B", companies: ["Recursion", "Exscientia"], summary: "Two AI-driven drug discovery leaders combine forces to create the largest computational biology platform in biopharma." },
  { id: "5", title: "Medtronic Launches $2B Surgical Robotics Fund", source: "MedTech Dive", time: "12h ago", type: "deal", amount: "$2B", companies: ["Medtronic"], summary: "Medtronic announces a dedicated $2B venture fund focused on next-generation surgical robotics and AI-assisted procedures." },
  { id: "6", title: "CureVac IPO Raises $1.2B on Nasdaq", source: "CNBC", time: "1d ago", type: "ipo", amount: "$1.2B", companies: ["CureVac"], summary: "German mRNA therapeutics company CureVac priced its IPO at $28 per share, raising $1.2B in the largest biotech IPO of Q1 2026." },
];
